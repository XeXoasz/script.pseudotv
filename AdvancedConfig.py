        ...
        if action in ACTION_PREVIOUS_MENU:
            ...
            try:
                if self.getFocusId() == 131:
                    RuleOptions = ("None", "Best-Effort Channel Scheduling", "Channel Logo", "Don't Include a Show", "Don't Play This Channel", "Even Show Distribution", "Handle BCT", "Force Random Mode", "Force Real-Time Mode", "Force Resume Mode", "Interleave Another Channel", "Only Play Unwatched Items", "Only Play Watched Items", "Pause When Not Watching", "Play TV Shows In Order", "Set Channel Name", "Reset Every x Days")
